...
IF ~Class(Myself,MAGE_ALL)
	...
	!Class(Myself,FIGHTER_MAGE_THIEF)~ DO ~CreateVisualEffectObject("c0darkbo",LastTalkedToBy(Myself))
	...
	ApplySpellRES("c0erase2",Myself)~ EXIT
IF ~Class(Myself,MAGE_ALL)
	!Class(Myself,SORCERER)
	OR(4)
	...
	OriginalClass(Myself,THIEF)~ DO ~CreateVisualEffectObject("c0darkbo",LastTalkedToBy(Myself))
	ActionOverride(LastTalkedToBy(Myself),AddKit(C0SADEPT))
	ActionOverride(Myself,SetGlobal("C0SALV1","LOCALS",0))
	ActionOverride(Myself,SetGlobal("C0SALV2","LOCALS",0))
	ActionOverride(Myself,SetGlobal("C0SALV3","LOCALS",0))
	...
	ActionOverride(Myself,SetGlobal("C0SALV8","LOCALS",0))
	ActionOverride(Myself,SetGlobal("C0SALV9","LOCALS",0))
	ApplySpellRES("c0sadual",Myself)
	ApplySpellRES("c0erase2",Myself)~ EXIT
IF ~Class(Myself,SORCERER)~ DO ~CreateVisualEffectObject("c0darkbo",LastTalkedToBy(Myself))
	...
	ActionOverride(Myself,SetGlobal("C0SALV9","LOCALS",0))
	ApplySpellRES("c0erase2",Myself)~ EXIT
IF ~Class(Myself,BARD_ALL)~ DO ~CreateVisualEffectObject("c0darkbo",LastTalkedToBy(Myself))
...
IF ~Class(Myself,FIGHTER_MAGE)
	!OriginalClass(Myself,FIGHTER)
	!OriginalClass(Myself,MAGE)~ DO ~CreateVisualEffectObject("c0darkbo",LastTalkedToBy(Myself))
