...
= IF ~%is_shadow_adept_lasttalkedtoby%~ THEN ~Hmm... and I just noticed that you have some skill in the Shadow Art. In that case, you can take my cloak as well. You should be able to make use of it. I have a spare one back home... I think.~
DO ~GiveItem("c0saclc2",LastTalkedToBy)~
= IF ~!%is_shadow_adept_lasttalkedtoby%
OR(6)
...
%is_shadow_adept_player6%~ THEN ~Hmm... and I just noticed that you have someone versed in the Shadow Art. In that case, you can take my cloak as well. You should be able to make use of it. I have a spare one back home... I think.~
DO ~GiveItem("c0saclc2",LastTalkedToBy)~
...
%is_shadow_adept_player4%
%is_shadow_adept_player5%
%is_shadow_adept_player6%~ + ~And what can be done with it?~ + ZAAL-COALITION-GEM-1
+ ~!%is_shadow_adept_player1%
!%is_shadow_adept_player2%
!%is_shadow_adept_player3%
!%is_shadow_adept_player4%
!%is_shadow_adept_player5%
!%is_shadow_adept_player6%~ + ~And what can be done with it?~ + ZAAL-COALITION-GEM-2
