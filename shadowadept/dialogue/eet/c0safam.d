...
CHAIN IF WEIGHT #-1 ~Global("C0SAFamiliarSummoned","GLOBAL",1) Alignment(Myself,MASK_LAWFUL)~ THEN C0SAFAM YINROU-EET-1
...
CHAIN IF WEIGHT #-1 ~Global("C0SAFamiliarSummoned","GLOBAL",1) Alignment(Myself,MASK_LCNEUTRAL)~ THEN C0SAFAM KASHAI-EET-1
...
CHAIN IF WEIGHT #-1 ~Global("C0SAFamiliarSummoned","GLOBAL",1) Alignment(Myself,MASK_CHAOTIC)~ THEN C0SAFAM NYX-EET-1
...
CHAIN IF WEIGHT #-1 ~Alignment(Myself,MASK_LAWFUL) !InPartySlot(LastTalkedToBy,0)~ THEN C0SAFAM YINROU-EET-2
...
CHAIN IF WEIGHT #-1 ~Alignment(Myself,MASK_LCNEUTRAL) !InPartySlot(LastTalkedToBy,0)~ THEN C0SAFAM KASHAI-EET-2
...
CHAIN IF WEIGHT #-1 ~Alignment(Myself,MASK_CHAOTIC) !InPartySlot(LastTalkedToBy,0)~ THEN C0SAFAM NYX-EET-2
...
CHAIN IF WEIGHT #-1 ~Global("C0SAFamiliarSummoned","GLOBAL",2) Alignment(Myself,MASK_LAWFUL) InPartySlot(LastTalkedToBy,0)~ THEN C0SAFAM YINROU-EET-3
...
END
+ ~Global("Background","LOCALS",0)~ + ~Tell me about yourself, Yin'rou.~ DO ~SetGlobal("Background","LOCALS",1)~ + YINROU-EET-3-4
++ ~Return to your home plane for now. I will call for you when you're needed.~ + YINROU-EET-3-1
++ ~You wouldn't happen to have any advice, would you?~ + YINROU-EET-3-2
+ ~Global("DisableFamiliarAI","LOCALS",0)~ + ~I want you to stop hiding while out of combat.~ DO ~SetGlobal("DisableFamiliarAI","LOCALS",1)~ + YINROU-EET-3-5
+ ~Global("DisableFamiliarAI","LOCALS",1)~ + ~I want you to hide in shadows while out of combat.~ DO ~SetGlobal("DisableFamiliarAI","LOCALS",0)~ + YINROU-EET-3-6
++ ~How are you? Is everything alright?~ + YINROU-EET-3-3
++ ~Nothing right now. Let's get moving.~ + YINROU-EET-3-0

CHAIN C0SAFAM YINROU-EET-3-0
~The shade wolf is turning to leave before you even finish your sentence. "As it should be, summoner."~
EXIT

CHAIN C0SAFAM YINROU-EET-3-1
...
IF ~Global("chapter","GLOBAL",SHADOW_ADEPT)~ EXTERN C0SAFAM YINROU-BG1-3-2o
IF ~Global("chapter","GLOBAL",13)~ EXTERN C0SAFAM YINROU-BG1-3-2p
IF ~Global("chapter","GLOBAL",13)
AreaType(DUNGEON)~ EXTERN C0SAFAM YINROU-BG2-3-2a
IF ~Global("chapter","GLOBAL",13)
!AreaType(DUNGEON)~ EXTERN C0SAFAM YINROU-BG2-3-2b
IF ~Global("chapter","GLOBAL",14)
AreaType(CITY)~ EXTERN C0SAFAM YINROU-BG2-3-2c
IF ~Global("chapter","GLOBAL",14)
!AreaType(CITY)~ EXTERN C0SAFAM YINROU-BG2-3-2d
IF ~Global("chapter","GLOBAL",15)~ EXTERN C0SAFAM YINROU-BG2-3-2e
IF ~Global("chapter","GLOBAL",16)~ EXTERN C0SAFAM YINROU-BG2-3-2f
IF ~Global("chapter","GLOBAL",17)~ EXTERN C0SAFAM YINROU-BG2-3-2g
IF ~Global("chapter","GLOBAL",18)~ EXTERN C0SAFAM YINROU-BG2-3-2h
IF ~Global("chapter","GLOBAL",19)~ EXTERN C0SAFAM YINROU-BG2-3-2i
IF ~Global("chapter","GLOBAL",20)~ EXTERN C0SAFAM YINROU-BG2-3-2j
IF ~Global("chapter","GLOBAL",21)~ EXTERN C0SAFAM YINROU-BG2-3-2k
IF ~Global("chapter","GLOBAL",22)~ EXTERN C0SAFAM YINROU-BG2-3-2l
...
CHAIN C0SAFAM YINROU-BG2-3-2j
~The wolf growls. "Our adversaries will only grow stronger from here on. Good... we will grow no stronger without a worthy challenge."~
EXIT

CHAIN C0SAFAM YINROU-BG2-3-2k
~The wolf snarls in disgust. "There is no satisfaction in crushing the weak. Only in conquering the strong. Let us show your divine siblings this simple truth."~
EXIT

CHAIN C0SAFAM YINROU-BG2-3-2l
~You doubt you have ever seen the wolf so thrilled. "Soon, summoner. Soon, we shall bring your destiny to its fruition. And then... we will destroy the fool who stands in your way."~
EXIT

CHAIN C0SAFAM YINROU-EET-3-3
...
END
IF ~!HPPercentLT(Myself,50) RandomNum(4,1)~ EXTERN C0SAFAM YINROU-EET-3-3a
IF ~!HPPercentLT(Myself,50) RandomNum(4,2)~ EXTERN C0SAFAM YINROU-EET-3-3b
IF ~!HPPercentLT(Myself,50) RandomNum(4,3)~ EXTERN C0SAFAM YINROU-EET-3-3c
IF ~!HPPercentLT(Myself,50) RandomNum(4,4)~ EXTERN C0SAFAM YINROU-EET-3-3d
IF ~HPPercentLT(Myself,50) !HPPercentLT("Myself",25)~ EXTERN C0SAFAM YINROU-EET-3-3e
IF ~HPPercentLT(Myself,25)~ EXTERN C0SAFAM YINROU-EET-3-3f

CHAIN C0SAFAM YINROU-EET-3-3a
~Yin'rou derisively snorts and turns away. "There is no time for small talk, summoner. We have much to do."~
EXIT

CHAIN C0SAFAM YINROU-EET-3-3b
...
CHAIN C0SAFAM YINROU-EET-3-5
~Very well, then. I will face our foes head on.~
EXIT

CHAIN C0SAFAM YINROU-EET-3-6
...
END
+ ~Global("Background","LOCALS",0)~ + ~Tell me about yourself, Ka'Shai.~ DO ~SetGlobal("Background","LOCALS",1)~ + KASHAI-EET-3-4
++ ~Return to your home plane for now. I will call for you when you're needed.~ + KASHAI-EET-3-1
++ ~You wouldn't happen to have any advice, would you?~ + KASHAI-EET-3-2
++ ~How are you? Is everything alright?~ + KASHAI-EET-3-3
+ ~Global("DisableFamiliarAI","LOCALS",0)~ + ~I want you to stop singing while in combat.~ DO ~SetGlobal("DisableFamiliarAI","LOCALS",1)~ + KASHAI-EET-3-5
+ ~Global("DisableFamiliarAI","LOCALS",1)~ + ~I want you to sing while of combat.~ DO ~SetGlobal("DisableFamiliarAI","LOCALS",0)~ + KASHAI-EET-3-5
++ ~Nothing right now. Let's get moving.~ + KASHAI-EET-3-0

CHAIN C0SAFAM KASHAI-EET-3-0
~"Yesss..." Ka'Shai's body passes through you as it continues along the path you are travelling.~
EXIT

CHAIN C0SAFAM KASHAI-EET-3-1
...
IF ~Global("chapter","GLOBAL",SHADOW_ADEPT)~ EXTERN C0SAFAM KASHAI-BG1-3-2o
IF ~Global("chapter","GLOBAL",13)~ EXTERN C0SAFAM KASHAI-BG1-3-2p
IF ~Global("chapter","GLOBAL",13)
AreaType(DUNGEON)~ EXTERN C0SAFAM KASHAI-BG2-3-2a
IF ~Global("chapter","GLOBAL",13)
!AreaType(DUNGEON)~ EXTERN C0SAFAM KASHAI-BG2-3-2b
IF ~Global("chapter","GLOBAL",14)~ EXTERN C0SAFAM KASHAI-BG2-3-2c
IF ~Global("chapter","GLOBAL",15)~ EXTERN C0SAFAM KASHAI-BG2-3-2d
IF ~Global("chapter","GLOBAL",16)~ EXTERN C0SAFAM KASHAI-BG2-3-2e
IF ~Global("chapter","GLOBAL",17)~ EXTERN C0SAFAM KASHAI-BG2-3-2f
IF ~Global("chapter","GLOBAL",18)~ EXTERN C0SAFAM KASHAI-BG2-3-2g
IF ~Global("chapter","GLOBAL",19)~ EXTERN C0SAFAM KASHAI-BG2-3-2h
IF ~Global("chapter","GLOBAL",20)~ EXTERN C0SAFAM KASHAI-BG2-3-2i
IF ~Global("chapter","GLOBAL",21)~ EXTERN C0SAFAM KASHAI-BG2-3-2j
IF ~Global("chapter","GLOBAL",22)~ EXTERN C0SAFAM KASHAI-BG2-3-2k
...
CHAIN C0SAFAM KASHAI-BG2-3-2i
~The shadow is contemplative. "Thou hassst achieved one great victory, massster... but further trialsss await thee, and the risssk shall be greater ssstill... but ssso ssshall the rewardsss..."~
EXIT

CHAIN C0SAFAM KASHAI-BG2-3-2j
~You sense a light hint of pity from the shadow. "Death continuesss to hound thy every ssstep, massster, whether by thy hand or no... when, I wonder, shall thee truly find ressst...?"~
EXIT

CHAIN C0SAFAM KASHAI-BG2-3-2k
~The shadow answers quickly, without hesitation. "The path isss clear, massster... win and control thy dessstiny, or lossse and be dessstroyed... there isss only one path, massster... consssume ssshe who would otherwise consssume thee..."~
EXIT

CHAIN C0SAFAM KASHAI-EET-3-3
~"..." The shadow ponders for a moment, as though it were unaware of its current state of wellbeing.~
END
IF ~!HPPercentLT(Myself,50) RandomNum(4,1)~ EXTERN C0SAFAM KASHAI-EET-3-3a
IF ~!HPPercentLT(Myself,50) RandomNum(4,2)~ EXTERN C0SAFAM KASHAI-EET-3-3b
IF ~!HPPercentLT(Myself,50) RandomNum(4,3)~ EXTERN C0SAFAM KASHAI-EET-3-3c
IF ~!HPPercentLT(Myself,50) RandomNum(4,4)~ EXTERN C0SAFAM KASHAI-EET-3-3d
IF ~HPPercentLT(Myself,50) !HPPercentLT("Myself",25)~ EXTERN C0SAFAM KASHAI-EET-3-3e
IF ~HPPercentLT(Myself,25)~ EXTERN C0SAFAM KASHAI-EET-3-3f

CHAIN C0SAFAM KASHAI-EET-3-3a
~Ka'Shai's head inclines towards you. "My form isss ssstable, massster. There isss nothing to fear..."~
EXIT

CHAIN C0SAFAM KASHAI-EET-3-3b
~Ka'Shai begins to drift away, lost in thought, seemingly forgotten that you had asked it a question.~
EXIT

CHAIN C0SAFAM KASHAI-EET-3-3c
~It finally appears to have found an answer. "All isss well..."~
EXIT

CHAIN C0SAFAM KASHAI-EET-3-3d
~Its humanoid form begins to take on a more coherent shape, as though reassuring you. "I am prepared for anything, massster..."~
EXIT

CHAIN C0SAFAM KASHAI-EET-3-3e
...
CHAIN C0SAFAM KASHAI-EET-3-5
~Assss you command, massster...~
EXIT

CHAIN IF WEIGHT #-1 ~Global("C0SAFamiliarSummoned","GLOBAL",2) Alignment(Myself,MASK_CHAOTIC) InPartySlot(LastTalkedToBy,0)~ THEN C0SAFAM NYX-EET-3
~Nyx looks back at you and crosses her arms impatiently. "Yeah, boss? Whatcha got for me this time?"~
END
+ ~Global("Background","LOCALS",0)~ + ~Tell me about yourself, Nyx.~ DO ~SetGlobal("Background","LOCALS",1)~ + NYX-EET-3-5
++ ~Return to your home plane for now. I will call for you when you're needed.~ + NYX-EET-3-1
++ ~You wouldn't happen to have any advice, would you?~ + NYX-EET-3-2
++ ~How are you? Is everything alright?~ + NYX-EET-3-3
+ ~Global("DisableFamiliarAI","LOCALS",0)~ + ~I want you to stop searching for traps.~ DO ~SetGlobal("DisableFamiliarAI","LOCALS",1)~ + NYX-EET-3-6
+ ~Global("DisableFamiliarAI","LOCALS",1)~ + ~I want you to search for traps.~ DO ~SetGlobal("DisableFamiliarAI","LOCALS",0)~ + NYX-EET-3-6
++ ~Give me anything you have pickpocketed, will you?~ + NYX-EET-3-4
++ ~Nothing right now. Let's get moving.~ + NYX-EET-3-0

CHAIN C0SAFAM NYX-EET-3-0
~The mephit shrugs. "If you say so."~
EXIT

CHAIN C0SAFAM NYX-EET-3-1
...
IF ~Global("chapter","GLOBAL",SHADOW_ADEPT)~ EXTERN C0SAFAM NYX-BG1-3-2o
IF ~!Global("ENDOFBG1","GLOBAL",2)
Global("chapter","GLOBAL",13)~ EXTERN C0SAFAM NYX-BG1-3-2p
IF ~Global("ENDOFBG1","GLOBAL",2)
Global("chapter","GLOBAL",13)
AreaType(DUNGEON)~ EXTERN C0SAFAM NYX-BG2-3-2a
IF ~Global("ENDOFBG1","GLOBAL",2)
Global("chapter","GLOBAL",13)
!AreaType(DUNGEON)~ EXTERN C0SAFAM NYX-BG2-3-2b
IF ~Global("chapter","GLOBAL",14)~ EXTERN C0SAFAM NYX-BG2-3-2c
IF ~Global("chapter","GLOBAL",15)~ EXTERN C0SAFAM NYX-BG2-3-2d
IF ~Global("chapter","GLOBAL",16)~ EXTERN C0SAFAM NYX-BG2-3-2e
IF ~Global("chapter","GLOBAL",17)~ EXTERN C0SAFAM NYX-BG2-3-2f
IF ~Global("chapter","GLOBAL",18)~ EXTERN C0SAFAM NYX-BG2-3-2g
IF ~Global("chapter","GLOBAL",19)~ EXTERN C0SAFAM NYX-BG2-3-2h
IF ~Global("chapter","GLOBAL",20)~ EXTERN C0SAFAM NYX-BG2-3-2i
IF ~Global("chapter","GLOBAL",21)~ EXTERN C0SAFAM NYX-BG2-3-2j
IF ~Global("chapter","GLOBAL",22)~ EXTERN C0SAFAM NYX-BG2-3-2k
...
CHAIN C0SAFAM NYX-BG2-3-2i
~The mephit sighs. "One of these days, I'm expecting the whole world to collapse over our heads, boss. Every time I think we're finally done, another bigger fish comes up. I just hope the treasures get bigger too..."~
EXIT

CHAIN C0SAFAM NYX-BG2-3-2j
~The mephit looks concerned. "Looks like the Bhaalspawn are finally acting against each other for real, boss. They ain't gonna mess around. On my part, I just hope you drew the jackpot on who gets to sit at the top."~
EXIT

CHAIN C0SAFAM NYX-BG2-3-2k
~Surprisingly, the mephit appears fairly unfazed. "Pretty simple, boss. We win, or we die. We're going to win, aren't we?"~
EXIT

CHAIN C0SAFAM NYX-EET-3-3
...
END
IF ~!HPPercentLT(Myself,50) RandomNum(4,1)~ EXTERN C0SAFAM NYX-EET-3-3a
IF ~!HPPercentLT(Myself,50) RandomNum(4,2)~ EXTERN C0SAFAM NYX-EET-3-3b
IF ~!HPPercentLT(Myself,50) RandomNum(4,3)~ EXTERN C0SAFAM NYX-EET-3-3c
IF ~!HPPercentLT(Myself,50) RandomNum(4,4)~ EXTERN C0SAFAM NYX-EET-3-3d
IF ~HPPercentLT(Myself,50) !HPPercentLT("Myself",25)~ EXTERN C0SAFAM NYX-EET-3-3e
IF ~HPPercentLT(Myself,25)~ EXTERN C0SAFAM NYX-EET-3-3f

CHAIN C0SAFAM NYX-EET-3-3a
~Nyx shrugs. "Everything feels fine, boss. Fingers are itchin', though. Any chance we'll find a few pockets for me to pick?"~
EXIT

CHAIN C0SAFAM NYX-EET-3-3b
~Nyx's stomach growls. "Oops... heh heh, you heard that, right, boss? Mind stoppin' for a snack break?~
EXIT

CHAIN C0SAFAM NYX-EET-3-3c
~Nyx scratches her head. "What'ya want me to say, boss? I've got nothin', really. Ready for action, as usual."~
EXIT

CHAIN C0SAFAM NYX-EET-3-3d
