...
IF ~~ DO ~IncrementGlobal("C0SALv1","GLOBAL",1) DestroyItem("c0sascr1") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~~ DO ~IncrementGlobal("C0SALv2","GLOBAL",1) DestroyItem("c0sascr2") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~~ DO ~IncrementGlobal("C0SALv3","GLOBAL",1) DestroyItem("c0sascr3") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~~ DO ~IncrementGlobal("C0SALv4","GLOBAL",1) DestroyItem("c0sascr4") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~~ DO ~IncrementGlobal("C0SALv5","GLOBAL",1) DestroyItem("c0sascr5") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~~ DO ~IncrementGlobal("C0SALv6","GLOBAL",1) DestroyItem("c0sascr6") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~ClassLevelGT(Myself,WIZARD,13)~ EXTRA7
SAY ~Reading this scroll allows you to learn one extra 7th level spell.~ [GAM_44]
IF ~~ DO ~IncrementGlobal("C0SALv7","GLOBAL",1) DestroyItem("c0sascr7") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~ClassLevelGT(Myself,WIZARD,15)~ EXTRA8
SAY ~Reading this scroll allows you to learn one extra 8th level spell.~ [GAM_44]
IF ~~ DO ~IncrementGlobal("C0SALv8","GLOBAL",1) DestroyItem("c0sascr8") StartDialogOverride("c0satalk",Myself)~ EXIT
END
...
IF ~ClassLevelGT(Myself,WIZARD,17)~ EXTRA9
SAY ~Reading this scroll allows you to learn one extra 9th level spell.~ [GAM_44]
IF ~~ DO ~IncrementGlobal("C0SALv9","GLOBAL",1) DestroyItem("c0sascr9") StartDialogOverride("c0satalk",Myself)~ EXIT
END
